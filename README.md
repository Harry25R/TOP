...
Version update includes a new CCA vs AUC plotting function (`CCA_AUC_plot`) and the ability to optimise lambda for sensitivity or specificity via the `metric` argument in `TOP_model`.
